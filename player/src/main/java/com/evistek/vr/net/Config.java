...
public class Config {
     ...
     */
    public static final String NET_SERVER_IP = "120.26.138.149";
    public static final String NET_SERVER_ADDRESS = "http://" + NET_SERVER_IP + ":8080/" + "version/VRPlayer/version_vrplayer.xml";
    ...
    public static final String URL_GET_AUDITED_VRONLINE = HOST +"/getAuditedVrOnline";
    public static final String URL_UPDATE_VRONLINE_PLAY_COUNT = HOST + "/updateVrOnlinePlayCount";
