...
import com.evistek.vr.activity.adapter.LocalVideoAdapter;
...
public class LocalVideoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) mRootView.findViewById(R.id.local_video_swipe_refresh_layout);
        ...
        mRecyclerView = (RecyclerView) mRootView.findViewById(R.id.local_video_recyclerview);
        mLinearLayoutManager = new LinearLayoutManager(getContext());
        mRecyclerView.setLayoutManager(mLinearLayoutManager);
        mRecyclerView.setAdapter(mAdapter);

        mProgressBar = (ProgressBar) mRootView.findViewById(R.id.local_video_progress_bar);
        return mRootView;
    }
